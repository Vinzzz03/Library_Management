  ...
  return (
    <div className="bg-gradient-to-r from-[#9bf7f4] to-[#707df7]">
      <div className="grid grid-cols-2 place-items-center h-50">
        <div>
          <Image src="/Unisys_logo.png" width={232.5} height={45} alt="Unisys Logo" className="px-12 pt-5" />
        ...
        <div>
          <Image src="/5f68631d2596dddefd5b23a1_Help (2) (1).png" width={700} height={700} alt="Library Management" className="left-0 top-0" />
        </div>
      </div>
    </div>
  );
